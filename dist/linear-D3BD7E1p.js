...
function k(a, o) {
	var s = typeof o, c;
	return o == null || s === "boolean" ? r(o) : (s === "number" ? n : s === "string" ? (c = e(o)) ? (o = c, t) : i : o instanceof e ? t : o instanceof Date ? ie : ne(o) ? te : Array.isArray(o) ? re : typeof o.valueOf != "function" && typeof o.toString != "function" || isNaN(o) ? ae : n)(a, o);
}
//#endregion
...
function ce(e, t, n) {
	...
	return i < r ? (r = P(i, r), a = n(o, a)) : (r = P(r, i), a = n(a, o)), function(e) {
		return a(r(e));
	};
}
function le(e, t, n) {
	var r = Math.min(e.length, t.length) - 1, i = Array(r), a = Array(r), o = -1;
	for (e[r] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++o < r;) i[o] = P(e[o], e[o + 1]), a[o] = n(t[o], t[o + 1]);
	return function(t) {
		var n = f(e, t, 1, r) - 1;
		return a[n](i[n](t));
	};
...
function I() {
	var e = M, t = M, r = k, i, a, o, s = N, c, l, u;
	function d() {
		var n = Math.min(e.length, t.length);
		return s !== N && (s = se(e[0], e[n - 1])), c = n > 2 ? le : ce, l = u = null, f;
	}
	function f(n) {
...
var B = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function V(e) {
	if (!(t = B.exec(e))) throw Error("invalid format: " + e);
	var t;
	return new H({
		fill: t[1],
		align: t[2],
...
function me(e, t) {
	...
	return a === o ? r : a > o ? r + Array(a - o + 1).join("0") : a > 0 ? r.slice(0, a) + "." + r.slice(a) : "0." + Array(1 - a).join("0") + R(e, Math.max(0, t + a - 1))[0];
}
//#endregion
...
function he(e) {
	var t = e.grouping === void 0 || e.thousands === void 0 ? K : de(q.call(e.grouping, Number), e.thousands + ""), n = e.currency === void 0 ? "" : e.currency[0] + "", r = e.currency === void 0 ? "" : e.currency[1] + "", i = e.decimal === void 0 ? "." : e.decimal + "", a = e.numerals === void 0 ? K : fe(q.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", s = e.minus === void 0 ? "−" : e.minus + "", c = e.nan === void 0 ? "NaN" : e.nan + "";
	function l(e, l) {
		e = V(e);
		...
		function w(e) {
			...
			if (y === "c") r = S(e) + r, e = "";
				...
				e = +e;
				var w = e < 0 || 1 / e < 0;
				if (e = isNaN(e) ? c : S(Math.abs(e), _), v && (e = pe(e)), w && +e == 0 && f !== "+" && (w = !1), n = (w ? f === "(" ? f : s : f === "-" || f === "(" ? "" : f) + n, r = (y === "s" && !isNaN(e) && U !== void 0 ? J[8 + U / 3] : "") + r + (w && f === "(" ? ")" : ""), C) {
	...
	function u(e, t) {
		var n = Math.max(-8, Math.min(8, Math.floor(z(t) / 3))) * 3, r = 10 ** -n, i = l((e = V(e), e.type = "f", e), { suffix: J[8 + n / 3] });
		return function(e) {
			return i(r * e);
		};
	}
...
function ge(e) {
	return Y = he(e), X = Y.format, Z = Y.formatPrefix, Y;
}
//#endregion
...
function be(e, t, n, r) {
	...
	switch (r = V(r ?? ",f"), r.type) {
		case "s":
			...
			return r.precision == null && !isNaN(a = ve(i, o)) && (r.precision = a), Z(r, o);
		case "":
		case "e":
		case "g":
		case "p":
		case "r":
			r.precision == null && !isNaN(a = ye(i, Math.max(Math.abs(e), Math.abs(t)))) && (r.precision = a - (r.type === "e"));
			break;
		case "f":
		case "%": r.precision == null && !isNaN(a = _e(i)) && (r.precision = a - (r.type === "%") * 2);
	}
	return X(r);
}
//#endregion
...
function Q(e) {
	...
	return e.ticks = function(e) {
		...
		var r = t();
		return be(r[0], r[r.length - 1], e ?? 10, n);
	}, e.nice = function(n) {
		n ??= 10;
...
//#endregion
export { s as C, u as S, a as T, C as _, L as a, f as b, I as c, k as d, D as f, T as g, E as h, V as i, j as l, ee as m, Q as n, F as o, O as p, X as r, N as s, $ as t, A as u, p as v, o as w, l as x, m as y };

//# sourceMappingURL=linear-D3BD7E1p.js.map